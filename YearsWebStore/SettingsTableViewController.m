...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [[ShopListModel sharedInstance] loadConnectedShop];
    cell.ShopID.text = [[[ShopListModel sharedInstance] currentSelectedShop] ID];
    if (!cell.ShopID.text || [cell.ShopID.text isEqual: @""]) {
        cell.ShopID.text = @"N/A";
    }
    // Configure the cell...
